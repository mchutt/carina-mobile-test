...
public class SignUpFormComponent extends AbstractUIObject implements ICustomTypePageFactory {
    ...
    public FullSignUpPageBase openFullSignUpPage() {
        return initPage(driver, FullSignUpPageBase.class);
    }
